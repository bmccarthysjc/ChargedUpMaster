...
public class SwerveBase extends SubsystemBase {
   ...
   */
  private static final double frontLeftAngleOffset = 58.007;
  private static final double frontRightAngleOffset = 256.552;
  private static final double rearLeftAngleOffset = 272.52;
  private static final double rearRightAngleOffset = 137.109;
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("pitch",
        navX.getPitch());
    SmartDashboard.putNumber("Front Right", frontRight.getAbsoluteAngle());
    SmartDashboard.putNumber("Front Left", frontLeft.getAbsoluteAngle());
    SmartDashboard.putNumber("Rear Right", rearRight.getAbsoluteAngle());
    SmartDashboard.putNumber("Rear Left", rearLeft.getAbsoluteAngle());
  }
